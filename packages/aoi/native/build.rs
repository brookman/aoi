...
// const IOS_C_OUTPUT: &str = "../../flutter_aoi/ios/Classes/frb.h";
// const MACOS_C_OUTPUT_DIR: &str = "../../flutter_aoi/macos/Classes/";
...
fn main() {
    ...
    codegen::generate(
        Config::from_config_file("../flutter_rust_bridge.yaml").unwrap().unwrap(),
        Default::default(),
    ).unwrap();
